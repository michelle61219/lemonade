<template>
	...
	>
		<div v-if="currentStatus === breathingStatus.breathOut" class="movingBg breathe-out"></div>
		<div v-else>
			<div v-if="currentStatus === breathingStatus.In" class="movingBg breathe-in"></div>
		</div>
	</div>
</template>
