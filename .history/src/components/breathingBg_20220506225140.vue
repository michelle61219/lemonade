...
export default {
	...
	methods: {
		...
		InhaleExhaleBg() {
			if (this.state === this.breathingStatus.breatheIn) {
				this.state = this.breathingStatus.breatheOut;
				setTimeout(() => {
					this.InhaleExhaleBg();
					//Moving Down
			...
			// First start in here !!!
			else if (this.state === this.breathingStatus.breatheOut) {
				this.state = this.breathingStatus.breatheIn;
				setTimeout(() => {
					this.InhaleExhaleBg();
					//Moving Up
