<template>
	<div class="time_section">
		...
		<div class="time_content">
			...
			<a-space>
				<a-input-number v-model:value="$store.state.timerStartMinute" :min="1" :max="60" :disabled="status !== 'pause'" 	@change="
						this.$store.commit('changeTimerStartMinute', $event.target.value)
					"/>
				<span>mins</span>
				<a-button type="primary" shape="circle" @click="value = 1">{{ buttonText }}</a-button>
			</a-space>
<!-- 
