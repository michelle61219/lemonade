<template>
	...
	>
		<div v-if="currentStatus === breathingStatus.breatheOut" class="movingBg breathe-out"></div>
		<div v-else>
			<div v-if="currentStatus === breathingStatus.breatheIn" class="movingBg breathe-in"></div>
		</div>
	</div>
</template>
