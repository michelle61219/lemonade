<template>
	<div class="inhaleExhale_section">
		<div v-if="breathingCurrentState === breathingStates.Out" class="movingBg breathe-out"></div>
		<div v-else>
			<div v-if="sbreathingCurrentState === breathingStates.Out" class="movingBg breathe-in"></div>
		</div>
	</div>
</template>
