<template>
	<div class="inhaleExhale_section">
		$store.state.countIn
		<div v-if="$store.state.breathingCurrentState === breathingStates.Out" class="movingBg breathe-out"></div>
		<div v-else>
			<div v-if="breathingCurrentState === breathingStates.In" class="movingBg breathe-in"></div>
		</div>
	</div>
</template>
