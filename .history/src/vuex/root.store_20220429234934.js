	...
	mutations: {
		...
		// resetTimer()
			...
			if (activateBreathingBg(state
				...
				if (breathingCurrentState === breathingStates.In) {
					breathingCurrentState = breathingStates.Out;
					setTimeout(() => {
						this.toggleBreath();
					}, countOut + countHold2);
				} else if (breathingCurrentState === breathingStates.Out) {
					breathingCurrentState = breathingStates.In;
					setTimeout(() => {
						this.toggleBreath();
					}, countIn + countHold1);
				}
